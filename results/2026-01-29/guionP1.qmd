...
```
:::
Para mover archivos o carpetas mediante un path relativo es posible utilizar el 
comando *cp* seguido de *../../../* las veces que sean necesarias hasta llegar
a home y luego seguir con *"nombrededirectorio"/"nombredearchivo"*
...
**He tenido que cambiar un Humana por Human, además he cambiado los directorios de guardado y lectura de archivos para que los .fa se guarden en la carpeta "data" mientras que los alineamientos se crean en la carpeta "results/2026-01-29"**
